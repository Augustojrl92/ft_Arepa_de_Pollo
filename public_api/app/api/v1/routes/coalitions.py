...
def _coalition_payload(coalition, member_count: int, active_member_count: int) -> dict:
    return {
...
def list_coalitions(
    ...
    for coalition, member_count, active_member_count in rows:
        items.append(
            CoalitionRead.model_validate(
                _coalition_payload(coalition, int(member_count), int(active_member_count))
            )
        )
...
def get_coalition(
    ...
    payload = CoalitionDetailRead.model_validate(
        {
            **_coalition_payload(coalition, member_count, active_member_count),
            "score_trends": {
